...
export default function SwapiSearchPlanets() {
  ...
  return (
    <div style={{ position: 'relative' }}>
      <div className={`ui action focus input ${noResults ? 'error' : ''}`}>
        <input type="text" placeholder="Search Planets" value={searchTerm} onChange={handleInputChange} onKeyDown={handleKeyDown} />
